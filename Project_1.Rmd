...
data.frame(mean=mean(Steps$Steps_per_day,
na.rm=TRUE),median=median(Steps$Steps_per_day, na.rm=TRUE)) 
```
...
data.frame(mean=mean(Steps_No_NA$Steps_per_day,na.rm=TRUE),
           median=median(Steps_No_NA$Steps_per_day, na.rm=TRUE)) 
```



##AQUI FALTA RESPONDER LAS PREGUNTAS
